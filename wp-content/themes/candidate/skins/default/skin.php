...
h4.styling2, .scroll_to_top:hover, .copyright_wrap .sc_socials .social_icons:hover span:before, .menu_main_wrap .menu_main_nav > li:last-child > a, .tribe-events-notices, .single-tribe_events .tribe-events-schedule .tribe-events-divider, .single-tribe_events .tribe-events-schedule .tribe-events-cost, .booking_back_today a:hover,
...
.home1-sl3-date, .sc_tooltip_parent, .widget_calendar .today .day_wrap, .widget_calendar td a:after,
.tribe-events-list-widget .entry-title a, .tribe-events-list-event-description.tribe-events-content a.tribe-events-read-more:hover, .link_color
				{
					color:'.esc_attr($clr).';
				}
...
.booking_day_container:hover .booking_day_slots, .tribe-events-widget-link .sc3_button, .tribe-events-widget-link .sc_button.sc_button_style_filled
				{
...
.custom_options.co_light #co_toggle, .booking_float_left .booking_clear_custom:hover, .esg-pagination-button, .esg-sortbutton-order,
...
.post_content.ih-item.square.effect_shift.colored .info,
  .hover_icon:hover::after, figure figcaption, .sc_image figcaption, .post_content.ih-item.circle.effect1.colored .info, .post_content.ih-item.circle.effect2.colored .info, .post_content.ih-item.circle.effect5.colored .info .info-back, .post_content.ih-item.circle.effect19.colored .info, .post_content.ih-item.square.effect4.colored .mask1, .post_content.ih-item.square.effect4.colored .mask2, .post_content.ih-item.square.effect6.colored .info, .post_content.ih-item.square.effect7.colored .info, .post_content.ih-item.square.effect12.colored .info, .post_content.ih-item.square.effect13.colored .info, .post_content.ih-item.square.effect_dir.colored .info, .post_content.ih-item.square.effect_shift.colored .info{
