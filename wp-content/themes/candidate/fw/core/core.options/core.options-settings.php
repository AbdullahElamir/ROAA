...
if ( !function_exists( 'axiom_options_settings_theme_setup' ) ) {
	...
	function axiom_options_settings_theme_setup() {
		...
		$AXIOM_GLOBALS['options_params'] = array(
            ...
            'list_above_sidebar_styles' => array('$axiom_get_list_above_sidebar_styles' => ''),
...
/*		"user_dark" => array(
		...
		'body_style' => array(
					"title" => __('Body style', 'axiom'),
					"desc" => __('Select body style:<br><b>boxed</b> - if you want use background color and/or image,<br><b>wide</b> - page fill whole window with centered content', 'axiom'),
					"divider" => false,
					"override" => "category,post,page",
					"std" => "wide",
...
/*		"customizer_demo" => array(
		...
		"sidebar_footer_columns" => array( 
					...
					"max" => 6,
					"type" => "spinner"),
        "show_above_sidebar_footer" => array(
                    "title" => __('Show above footer sidebar', 'axiom'),
                    "desc" => __('Select style for the above footer sidebar or hide it', 'axiom'),
                    "override" => "category,post,page",
                    "std" => "none",
                    "options" => $AXIOM_GLOBALS['options_params']['list_above_sidebar_styles'],
                    "dir" => "horizontal",
                    "type" => "checklist"),

        "above_sidebar_footer" => array(
                    "title" => __('Select above footer sidebar',  'axiom'),
                    "desc" => __('Select above footer sidebar for the blog page',  'axiom'),
                    "override" => "category,post,page",
                    "divider" => false,
                    "std" => "above_sidebar_footer",
                    "options" => $AXIOM_GLOBALS['options_params']['list_above_sidebar_styles'],
                    "type" => "select"),

        "above_sidebar_footer_columns" => array(
                    "title" => __('Above Footer sidebar columns',  'axiom'),
                    "desc" => __('Select columns number for the above footer sidebar',  'axiom'),
                    "override" => "category,post,page",
                    "divider" => false,
                    "std" => 3,
                    "min" => 1,
