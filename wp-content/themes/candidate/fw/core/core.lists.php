...
// Return background tints list for above_sidebars, prepended inherit
if ( !function_exists( 'axiom_get_list_above_sidebar_styles' ) ) {
    function axiom_get_list_above_sidebar_styles($prepend_inherit=false) {
        global $AXIOM_GLOBALS;
        if (isset($AXIOM_GLOBALS['list_above_sidebar_styles']))
            $list = $AXIOM_GLOBALS['list_above_sidebar_styles'];
        else {
            $list = array();
            $list['none']  = __('None',  'axiom');
            ...
            $list['dark']  = __('Dark',  'axiom');
            $AXIOM_GLOBALS['list_above_sidebar_styles'] = $list = apply_filters('axiom_filter_sidebar_styles', $list);
        }
        return $prepend_inherit ? axiom_array_merge(array('inherit' => __("Inherit", 'axiom')), $list) : $list;
    }
}
