			...
			$AXIOM_GLOBALS['shortcodes'] = array(
				...
				"trx_blogger" => array(
					...
					"params" => array(
                        ...
                        "stylebutton2" => array(
                            "title" => __("Show style 2 for button", "axiom"),
                            "desc" => __("Show style 2 for button", "axiom"),
                            "value" => "yes",
                            "type" => "switch",
                            "options" => $AXIOM_GLOBALS['sc_params']['yes_no']
                        ),
				...
				"trx_quote" => array(
					...
					"params" => array(
                        ...
                        "position" => array(
                            "title" => __("Position (author)", "axiom"),
                            "desc" => __("Quote title (author position)", "axiom"),
                            "value" => "",
                            "type" => "text"
                        ),
						"_content_" => array(
				...
				"trx_title" => array(
					...
					"params" => array(
						...
						"h4_styling" => array(
							"title" => __('H4 additional style.', "axiom"),
							"desc" => __("Select H4 additional style. Top, bottom or none.", "axiom"),
							"dependency" => array(
								'type' => array('4')
							),
							"readonly" => false,
							...
							"options" => array(
								'0' => __('None', 'axiom'),
								'1' => __('Line on the right', 'axiom'),
                                '2' => __('Line on the right2', 'axiom')
							)
						),
						"style" => array(
