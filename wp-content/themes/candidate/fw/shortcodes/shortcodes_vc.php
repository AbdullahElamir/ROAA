...
//					),
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        "param_name" => "stylebutton2",
                        "heading" => __("Show style 2 for button", "axiom"),
                        "description" => __("Show style 2 for button", "axiom"),
                        "group" => __('Details', 'axiom'),
                        "class" => "",
                        "value" => array(__('Button style2', 'axiom') => 'yes'),
                        "type" => "checkbox"
                    ),
					array(
...
//					),
			...
			class WPBakeryShortCode_Trx_Dropcaps extends AXIOM_VC_ShortCodeContainer {}
...
//					)
			...
			class WPBakeryShortCode_Trx_Highlight extends AXIOM_VC_ShortCodeContainer {}
...
//					),
			...
			class WPBakeryShortCode_Trx_List_Item extends AXIOM_VC_ShortCodeContainer {}
...
//					),
			...
			vc_map( array(
				...
				"params" => array(
                    ...
                    array(
                        "param_name" => "position",
                        "heading" => __("Position (author)", "axiom"),
                        "description" => __("Quote title (author position)", "axiom"),
                        "admin_label" => true,
                        "class" => "",
                        "value" => "",
                        "type" => "textfield"
			...
			class WPBakeryShortCode_Trx_Quote extends AXIOM_VC_ShortCodeContainer {}
...
//					),
			...
			vc_map( array(
				...
				"params" => array(
                    array(
                        "param_name" => "title",
                        "heading" => __("Title", "axiom"),
                        "description" => __("Title of testimonmials block", "axiom"),
                        "admin_label" => true,
                        "class" => "",
                        "value" => "",
                        "type" => "textfield"
                    ...
                    array(
                        "param_name" => "style",
                        "heading" => __("Output style", "axiom"),
                        "description" => __("Select desired style for testimonials", "axiom"),
                        "admin_label" => true,
                        "class" => "",
                        "value" => array(
                            __('style1', 'axiom') => 'style1',
                            __('style2', 'axiom') => 'style2'
                        ),
                        "type" => "dropdown"
                    ),
					array(
			...
			class WPBakeryShortCode_Trx_Testimonials_Item extends AXIOM_VC_ShortCodeContainer {}
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "h4_styling",
						"heading" => __("H4 additional style.", "axiom"),
						...
						"value" => array(
							__('None', 'axiom') => '0',
							__('Line on the right', 'axiom') => '1',
                            __('Line on the right2', 'axiom') => '2'
						),
						"type" => "dropdown"
					),
					array(
